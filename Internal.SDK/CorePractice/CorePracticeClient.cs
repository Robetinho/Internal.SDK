...
namespace Internal.SDK.CorePractice
{
    ...
    {
        public CorePracticeClient(HttpClient? httpClient = null, ISystemLoggerClient? systemLoggerClient = null) : base("http://localhost:5007/", "api/ai-session", httpClient, systemLoggerClient) { }
