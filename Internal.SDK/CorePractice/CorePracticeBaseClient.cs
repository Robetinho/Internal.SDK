...
namespace Internal.SDK.CorePractice
{
    ...
    public abstract class CorePracticeBaseClient : ClientBase<CorePracticeError>, ICorePracticeClient
    {
        internal CorePracticeBaseClient(string domain, HttpClient? httpClient = null, ISystemLoggerClient? systemLoggerClient = null) : base(domain, "api/core-practice", httpClient, systemLoggerClient) { }
