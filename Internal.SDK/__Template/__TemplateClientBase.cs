...
namespace Internal.SDK.__Template
{
    ...
    {
        public __TemplateClientBase(string domain, HttpClient? httpClient = null, ISystemLoggerClient? systemLoggerClient = null) 
            : base(domain, "api/ai-session", httpClient, systemLoggerClient) { }
